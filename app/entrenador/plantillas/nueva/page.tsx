  ...
  return (
    <div className="w-full">
      ...
      <main className="container mx-auto px-4 py-8 max-w-3xl">
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-balance">Nueva Plantilla</h2>
          <p className="text-muted-foreground mt-1">Armá una plantilla de ejercicios para reutilizar en rutinas</p>
        </div>

        <TemplateForm mode="create" exerciseCatalog={exerciseCatalog || []} />
      </main>
    </div>
  )
}
