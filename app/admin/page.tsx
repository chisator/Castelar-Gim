        ...
        <div className="container mx-auto flex min-h-[5rem] items-center justify-between px-4 py-2 relative">
          <div className="flex items-center gap-4">
            ...
            <div className="hidden sm:block border-l pl-4 border-gray-300">
              <p className="text-xs font-semibold text-gray-500 uppercase tracking-widest">Panel de<br />Administración</p>
            </div>
            <div className="sm:hidden">
              <p className="text-xs font-semibold text-gray-500 uppercase tracking-widest">Admin</p>
            </div>
          </div>
