...
description: React and Next.js performance optimization guidelines from Vercel Engineering. Apply when writing, reviewing, or refactoring React/Next.js code, implementing data fetching, or optimizing bundle size.
---
